...
> **최신 작업 상태 — 2026-09-13:** [글 기반 이미지 작업 중단·복구 핸드오프](docs/superpowers/handoffs/wj-article-images-stopped-2026-09-13.md)를 먼저 확인한다. 이미지 구현은 **STOPPED / NOT ACCEPTED**다. 호스트 검증 미실행 주장을 정정했으며, 자원·실행 차단·공유 캐시 조사와 최신 검증/독립 리뷰가 남았다. 이번 문서 커밋은 구현 완료나 DB/발행/배포 승인이 아니다. 아래는 기존 운영 인계 이력이다.
